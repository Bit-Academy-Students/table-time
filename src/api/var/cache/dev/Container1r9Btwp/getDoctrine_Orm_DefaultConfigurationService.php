...
class getDoctrine_Orm_DefaultConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Customers/CustomerEntity')], true)), 'App\\Customers\\CustomerEntity');

        $instance->setEntityNamespaces(['App' => 'App\\Customers\\CustomerEntity']);
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Customers\\CustomerRepository\\CustomerRepository' => ['privates', 'App\\Customers\\CustomerRepository\\CustomerRepository', 'getCustomerRepositoryService', true],
        ], [
            'App\\Customers\\CustomerRepository\\CustomerRepository' => '?',
        ])));
