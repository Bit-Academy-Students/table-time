...
final class Version20251114131901 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation_entity (id INT AUTO_INCREMENT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, amount_people INT NOT NULL, Email varchar(255) NOT NULL, RestaurantId INT DEFAULT NULL, INDEX IDX_46D90DF399EB28EB (RestaurantId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
